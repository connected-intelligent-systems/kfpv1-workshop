...
def image_segmentation(
    ...
    TRAIN_IMG_DIR: str = '/usr/share/kfpv1-workshop/brain-mri/notebooks_data_preparation/yolo/datasets/yolo_mri_brain/train/images',
    TRAIN_MASK_DIR: str = '/usr/share/kfpv1-workshop/brain-mri/notebooks_data_preparation/yolo/datasets/yolo_mri_brain/train/masks',
    VAL_IMG_DIR: str = '/usr/share/kfpv1-workshop/brain-mri/notebooks_data_preparation/yolo/datasets/yolo_mri_brain/valid/images',
    VAL_MASK_DIR: str = '/usr/share/kfpv1-workshop/brain-mri/notebooks_data_preparation/yolo/datasets/yolo_mri_brain/valid/masks',
    IMG_HEIGHT: int = 256, 
    IMG_WIDTH: int = 256, 
    BATCH_SIZE: int = 8, 
    NUM_WORKERS: int = 2,
